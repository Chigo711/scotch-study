    ...
    <SafeAreaView className="flex-1 bg-background">
      ...
      <View className="items-center py-5">
        <View className="mb-3.5 relative">
          ...
          <View className="absolute bottom-[2px] right-[2px] h-[18px] w-[18px] rounded-[15px] bg-accent-secondary border-[3px] border-background " />
        </View>

        <Text className="text-2xl font-bold text-foreground">{user?.fullName || user?.username || "student"}
        </Text>
        <Text className="text-base mt-0.5 text-foreground">{user?.primaryEmailAddress?.emailAddress}
        </Text>
        <View className="mt-3 flex-row items-center gap-1.5 rounded-full bg-[#fdcb6e1e] px-3.5 py-1.5">
          ...
          <Text className="text-sm text-[#fdcb6e] font-semibold">7 day study</Text>
        </View>
        ...
        <View className="flex-1 items-center rounded-2xl border border-border bg-surface px-4 py-4">
          ...
          <Text className="mt-1 text-sm text-foreground-muted">Sessions</Text>
        </View>
        <View className="flex-1 items-center rounded-2xl border border-border bg-surface px-4 py-4">
          <Text className="text-2xl font-bold text-primary">12</Text>
          <Text className="mt-1 text-sm text-foreground-muted">Partners</Text>
        </View>
        <View className="flex-1 items-center rounded-2xl border border-border bg-surface px-4 py-4">
          <Text className="text-2xl font-bold text-primary">48h</Text>
          <Text className="mt-1 text-sm text-foreground-muted">Study Time</Text>
        </View>
      </View>
